...
本书凝聚了“玉兰”项目团队的核心开发经验。为服务更广泛的开发者生态，“玉兰”项目在提供主流 PyTorch 实现的同时，也完成了对 PaddlePaddle 框架的同步支持（[PaddlePaddle版本](https://github.com/RUC-GSAI/YuLan-Chat-Paddle)），确保了技术的通用性与自主性。本书的撰写与出版工作，荣幸地获得了北京市科技计划的立项支持，这既是对我们技术路线的肯定，也为本书内容的深度与质量提供了坚实保障。
